[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_extra_view/raw/main/dist/nv_extra_view_v0.99.0.pyz)
...
Download the latest release [nv_extra_view_v0.99.0.pyz](https://github.com/peter88213/nv_extra_view/raw/main/dist/nv_extra_view_v0.99.0.pyz)

- Launch *nv_extra_view_v0.99.0.pyz* by double-clicking (Windows/Linux desktop),
- or execute `python nv_extra_view_v0.99.0.pyz` (Windows), resp. `python3 nv_extra_view_v0.99.0.pyz` (Linux) on the command line.
