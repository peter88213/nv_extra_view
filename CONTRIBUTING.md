...
For creating a message catalog, you download a template with all English messages from [here](https://github.com/peter88213/nv_extra_view/blob/main/i18n/messages.pot). 
...
Name the binary file **nv_extra_view.mo**. 


### Install your translation for testing

Add a subdirectory tree to **~/.novx/locale**, and place *nv_extra_view.mo* there, like this:
...
**HINT:** *nv_extra_view* comes with German translations. Look at the `de` directory tree, if you need an example. 
